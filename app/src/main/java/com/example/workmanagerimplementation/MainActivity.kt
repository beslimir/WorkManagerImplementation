...
import com.example.workmanagerimplementation.ui.theme.WorkManagerImplementationTheme
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            WorkManagerImplementationTheme {
                ...
                val filterInfo = remember(key1 = workInfo) {
                    workInfo?.find { it.id == colorFilterWorker.id }
                }
